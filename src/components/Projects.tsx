  ...
  const projects = [
    {
      id: 'anicat',
      name: 'anicat.fun',
      description: 'Веб-сайт с современным дизайном и функциональностью. Демонстрирует мои навыки в создании интерактивных пользовательских интерфейсов.',
      ...
      details: {
        ...
        results: '1000+ посетителей в месяц, высокие оценки пользователей',
        github: '#',
